    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=dat-san-bay" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt sân bay</a>
            </li>
...
<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="image/logoTopcafe.png" class="imgLogoTop" style="width: 50%;" /></a>
